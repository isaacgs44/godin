...
public class Indicadores {
    ...
    private Double deudoresDiv;
    private double porDebClientes;
    private double porDebDiv;
    private Double saldoClientes;
    private Double saldoDeuDiv;
    ...
    private void calculaDeben() {
        ...
        deudoresDiv = deuDiv.getSaldo();
        deben = clientes.getSaldo() + deuDiv.getSaldo();
        saldoClientes = clientes.getSaldo();
        saldoDeuDiv = deuDiv.getSaldo();
    }
    ...
    private Double calcPorDeben() {
        ...
        this.porDebClientes = clientes.getSaldo() / this.balgen.getSumaAct();
        this.porDebDiv = deudores.getSaldo() / this.balgen.getSumaAct();
    ...
    private Double calcPagosEnCurso() { // Calcula el monto promedio de pagos
        ...
        String periodo = periodos[periodos.length - 1];
        Integer dia = null;
        Integer mes = null;
        Integer anio = null;
    ...
    public Double getDeudoresDiv() {
        return deudoresDiv;
    }

    public double getPorDebClientes() {
        return porDebClientes;
    }

    public double getPorDebDiv() {
        return porDebDiv;
    }

    public Double getSaldoClientes() {
        return saldoClientes;
    }

    public Double getSaldoDeuDiv() {
        return saldoDeuDiv;
    }
