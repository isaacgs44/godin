 ...
 * @author lenovo
 */
public class DialogoModificarProd extends javax.swing.JDialog {
boolean datosValidos = true;
    Producto prod;
    DialogoAdminProducto vP;
    Utilidades uts;
    /**
     * Creates new form DialogoModificarProd
     */
    public DialogoModificarProd(java.awt.Frame parent, boolean modal,DialogoAdminProducto vP, String cod) {
        super(parent, modal);
        initComponents(); 
        this.vP = vP;
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnAceptar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            if(txtNombre.getText().length()!=0 && txtMarca.getText().length()!=0 && txtPrecioV.getText().length()!=0){
                ...
                if(nombre || marca || tipo || precioV){
                    ...
                    if(p.actualizarProducto(valores,prod.getCodigoBarras())){
                        uts.ventanaInfo(new JFrame(), "Datos actualizados", "Aviso");
                        vP.setEnabled(true);
                        vP.actualizarDatos();
                        dispose();
                    }else{
                        uts.ventanaError(new JFrame(), "Error al actualizar datos", "Aviso");
                        vP.setEnabled(true);
                        dispose();
                    }
                }else{
                    uts.ventanaError(new JFrame(),"No hay modificaciones", "Aviso");
                    vP.setEnabled(true);
                    vP.actualizarDatos();
                    dispose();
                }
